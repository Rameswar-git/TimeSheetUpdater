...
public class SkyloTimeSheetUpdater implements TimeSheetUpdater {

	@Override
	public List<WebElement> locateElement(WebDriver driver) throws InterruptedException {
		try {
			WebElement workHrlFld = driver.findElement(By.xpath("//*[@id=\"hours_1907_56\"]"));
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", workHrlFld);
			TimeUnit.SECONDS.sleep(5);
			WebElement workDescFld = driver.findElement(By.xpath("//*[@id=\"notes_1907_56\"]"));
			workHrlFld.click();
